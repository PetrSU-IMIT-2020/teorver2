...
В 1-м 3-м случаях множество *T дискретно, т.е. аргументпринимает дискретные значенияобычнов 1-м случае множество значений случайной функцииопределяются равенствами:, является дискретное множество(множествоконечно или счетное).
